...
<nav aria-label="...">
  <ul class="pager">
    <li class="previous"><a href="car1.php"><span aria-hidden="true">&larr;</span> Previous</a></li>
    <li class="next"><a href="car3.php">Next<span aria-hidden="true">&rarr;</span></a></li>
  </ul>
</nav>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="benz 1.jpg" width="100%" alt="Los Angeles">
    </div>

    <div class="item">
      <img src="benz 2.jpg" width="100%"alt="Chicago">
    </div>

    <div class="item">
      <img src="benz 3.jpg" width="100%" alt="New York">
    </div>
  </div>
