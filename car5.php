...
<nav aria-label="...">
  <ul class="pager">
    <li class="previous"><a href="car4.php"><span aria-hidden="true">&larr;</span> Previous</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="chevrolet 1.jpg" width="100%" alt="Los Angeles">
    </div>

    <div class="item">
      <img src="chevrolet 2.jpg" width="100%"alt="Chicago">
    </div>

    <div class="item">
      <img src="chevrolet 3.jpg" width="100%" alt="New York">
    </div>
  </div>
